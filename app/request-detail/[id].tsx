...
const styles = StyleSheet.create({
  ...
  locationName: { fontSize: 20, fontWeight: "600", color: Colors.light.text, fontFamily: "Archivo_600SemiBold" },
  ...
  rewardText: { fontSize: 18, fontWeight: "600", color: "#fff", fontFamily: "Archivo_600SemiBold" },
  ...
  chipText: { fontSize: 13, fontWeight: "500", color: Colors.light.tint, fontFamily: "Archivo_500Medium" },
  ...
  detailIcon: { width: 38, height: 38, borderRadius: 12, backgroundColor: "rgba(0,174,239,0.08)", alignItems: "center", justifyContent: "center" },
  detailInfo: { flex: 1 },
  detailLabel: { fontSize: 12, color: Colors.light.textSecondary, fontFamily: "Archivo_400Regular" },
  detailValue: { fontSize: 15, fontWeight: "500", color: Colors.light.text, marginTop: 1, fontFamily: "Archivo_500Medium" },
  detailDivider: { height: 1, backgroundColor: "rgba(0,0,0,0.04)", marginHorizontal: 14 },
  instructionsCard: { backgroundColor: "rgba(123,192,67,0.06)", borderRadius: 16, padding: 16, borderLeftWidth: 3, borderLeftColor: Colors.light.accent },
  instructionsTitle: { fontSize: 14, fontWeight: "600", color: Colors.light.text, marginBottom: 6, fontFamily: "Archivo_600SemiBold" },
  instructionsText: { fontSize: 14, color: Colors.light.text, lineHeight: 20, fontFamily: "Archivo_400Regular" },
  photoSection: { gap: 8 },
  photoContainer: { borderRadius: 18, overflow: "hidden", backgroundColor: Colors.light.border },
  ...
  ignoreBtn: {
    ...
    paddingVertical: 16, borderRadius: 16, borderWidth: 1.5, borderColor: Colors.light.border,
  },
  ignoreBtnText: { fontSize: 15, fontWeight: "500", color: Colors.light.textSecondary, fontFamily: "Archivo_500Medium" },
  acceptBtn: {
  ...
  acceptBtnText: { color: "#fff", fontSize: 16, fontWeight: "600", fontFamily: "Archivo_600SemiBold" },
  completedBanner: {
    flex: 1, flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 8,
    paddingVertical: 14, backgroundColor: "rgba(123,192,67,0.1)", borderRadius: 16,
  },
  completedText: { fontSize: 15, fontWeight: "600", color: Colors.light.accent, fontFamily: "Archivo_600SemiBold" },
});
